...
define('DOMAIN_URL', 'https://kalyanbazzar.greymatterworks.in/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_pass = "Kalyan@0111";  // Change as required
